...
var selection = __webpack_require__(1);
...
/* harmony default export */ var src_select = (function(selector) {
  return typeof selector === "string"
      ? new selection["a" /* Selection */]([[document.querySelector(selector)]], [document.documentElement])
      : new selection["a" /* Selection */]([[selector]], selection["c" /* root */]);
});
...
/* harmony default export */ var create = (function(name) {
  return src_select(Object(creator["a" /* default */])(name).call(document.documentElement));
});
...
var namespaces = __webpack_require__(3);
...
var src_selector = __webpack_require__(5);

// EXTERNAL MODULE: ./node_modules/d3-selection/src/selectorAll.js
var selectorAll = __webpack_require__(9);
...
var src_window = __webpack_require__(7);
...
"use strict";
/* harmony import */ var _namespace__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var _namespaces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
...
"use strict";
/* harmony import */ var _namespaces__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
var cubic = __webpack_require__(8);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ContextMenu = exports.ContextMenuOption = void 0;
var d3_selection_1 = __webpack_require__(0);
__webpack_require__(22);
__webpack_require__(12);
var d3_ease_1 = __webpack_require__(12);
var lodash_1 = __webpack_require__(18);
var uuid_1 = __webpack_require__(23);
var Event_1 = __webpack_require__(21);
var ContextMenuOption = /** @class */ (function () {
    function ContextMenuOption() {
        this.id = btoa(uuid_1.v4());
        this.selector = 'body'; // 生效范围
        this.menus = []; // 菜单列表
        this.maxWidth = 160; // 菜单最大长度
        this.size = 'default'; // min-height:'24|32|40' font-size:'10|12|14'
        this.duration = 100; // 动画时长
        this.mode = 'default'; // default: 默认自适应高，超出最大长度（maxWidth）自动换行  fixed: 固定高度，超出省略号
        this.ulClassName = '';
    }
...
var ContextMenu = /** @class */ (function () {
    function ContextMenu(option) {
        var _this_1 = this;
        this.option = new ContextMenuOption();
        /**
         * 关闭主菜单
         */
        this.closeContextMenu = lodash_1.debounce(function () {
            d3_selection_1.select("#" + _this_1.option.id + " ul.contextmenu")
                .style('overflow', 'hidden')
                .transition()
                .duration(_this_1.option.duration)
         ...
         * @param array 菜单元素集合
         */
        this._handleClick = lodash_1.debounce(function (data, i, array) {
            if (data.children && data.children.length > 0) {
                _this_1._showChildMenu(data, i, array[i]);
            }
            else {
                if (data.handler && data.handler instanceof Function)
                    data.handler();
                _this_1.closeContextMenu();
            }
        }, this.option.duration, { leading: true, trailing: false });
        this.option = __assign(__assign({}, this.option), option); // 初始化数据
        this.wrap = d3_selection_1.select('body') // 初始化根元素
            .append('div')
            .attr('id', this.option.id)
            .classed('contextmenu-wrap', true);
        this._initListener();
    }
    ContextMenu.prototype._initListener = function () {
        d3_selection_1.select(this.option.selector).on(Event_1.Event.CONTEXTMENU, this.showContextMenu.bind(this));
        d3_selection_1.select(this.option.selector).on(Event_1.Event.CLICK, this.closeContextMenu.bind(this));
    };
    /**
     * 销毁组件元素
     */
    ...
    ContextMenu.prototype.showContextMenu = function () {
        ...
        var root = d3_selection_1.select("#" + this.option.id + " ul.contextmenu");
        if (!root || !root.node()) {
            root = this._createMenu(event, this.wrap, __assign(__assign({}, this.option), { ulClassName: '' }));
        }
        root
            ...
            .style('overflow', 'hidden');
        // 计算菜单元素长高
        var _a = this._calc(root), width = _a.width, height = _a.height;
        // 添加过渡效果
        root
            .style('width', "0px")
            .style('height', "0px")
     ...
     * @param ul
     */
    ContextMenu.prototype._calc = function (ul) {
        var _this_1 = this;
        var width = 0;
        var height = 0;
        // 计算自适应宽高
        Array.from(ul.node().children).forEach(function (n) {
            if (n.offsetWidth > width) {
                width = n.offsetWidth > _this_1.option.maxWidth ? _this_1.option.maxWidth : n.offsetWidth;
     ...
     */
    ContextMenu.prototype._createMenu = function (_a, selection, option) {
        var x = _a.x, y = _a.y;
        var _this = this;
        // 生成ul元素
        var ul = selection
        ...
        ul.selectAll('li')
            ...
            .on(Event_1.Event.MOUSEENTER, function (data, i, array) {
            if (option.mode == 'fixed') {
                d3_selection_1.select(array[i]).attr('title', data.name);
            }
            _this._handleMouseEnter.bind(_this)(data, i, array);
        })
            .on(Event_1.Event.MOUSELEAVE, _this._handleMouseLeave.bind(_this))
            .on(Event_1.Event.CLICK, _this._handleClick.bind(_this))
            .html(function (d) {
            var html = "<span class=\"contextmenu-item-label\">" + d.name + "</span>";
        ...
        if (option.mode == 'fixed') {
            ul.classed('fixed', true)
                .selectAll('li')
                .style('height', function (data, i, array) {
                array[i].style.height = array[i].offsetHeight + "px";
            });
        }
        return ul;
    };
    ContextMenu.prototype._showChildMenu = function (data, i, el) {
        d3_selection_1.select(el.parentNode).style('overflow', 'unset');
        var childMenu = d3_selection_1.select(el).select(".contextmenu-child-" + i);
        if (!childMenu.node()) {
            childMenu = this._createMenu({ x: el.offsetWidth, y: 0 }, d3_selection_1.select(el), __assign(__assign({}, this.option), { ulClassName: "contextmenu-child-" + i, menus: data.children }));
        }
        var _a = this._calc(childMenu), width = _a.width, height = _a.height;
        childMenu
            .style('width', "0px")
            .style('height', height + "px")
            .transition()
    ...
    ContextMenu.prototype._closeChildMenu = function (data, i, el) {
        var childUl = Array.from(el.children).find(function (e) { return e.tagName === 'UL'; });
        if (childUl) {
            d3_selection_1.select(childUl)
                .style('overflow', 'hidden')
                .transition()
                .duration(this.option.duration)
                .ease(d3_ease_1.easeLinear)
     ...
     * @param array 菜单元素集合
     */
    ContextMenu.prototype._handleMouseEnter = function (data, i, array) {
        if (data.children && data.children.length > 0) {
     ...
     * @param array 菜单元素集合
     */
    ContextMenu.prototype._handleMouseLeave = function (data, i, array) {
        if (data.children && data.children.length > 0) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getMenus = exports.Main = void 0;
__webpack_require__(16);
var ContextMenu_1 = __webpack_require__(17);
var d3_selection_1 = __webpack_require__(0);
var Main = /** @class */ (function () {
    function Main() {
        ...
        this.demo();
        d3_selection_1.select('body').on('click', function () {
            _this.contextmenus.forEach(function (cm) {
                cm.closeContextMenu();
            });
        });
    }
    Main.prototype.demo = function () {
        this.defaultModeDemo();
        this.fixModeDemo();
        this.sizeDemo();
    };
    // 1.1 默认，菜单大小自适应(default)
    Main.prototype.defaultModeDemo = function () {
        d3_selection_1.select('.container .mode-default-wrap')
            .append('div')
            .classed('mode-default', true);
        var log = d3_selection_1.select('.mode-default-wrap>div:first-child');
    ...
    // 1.2 固定菜单大小(fixed)
    Main.prototype.fixModeDemo = function () {
        d3_selection_1.select('.container .mode-fixed-wrap')
            .append('div')
            .classed('mode-fixed', true);
        var log = d3_selection_1.select('.mode-fixed-wrap>div:first-child');
        var contextmenu = new ContextMenu_1.ContextMenu({
            selector: '.mode-fixed',
            mode: 'fixed',
            menus: getMenus(log)
    ...
    // 2 菜单大小
    Main.prototype.sizeDemo = function () {
        d3_selection_1.select('.container .size-wrap')
            .append('div')
        ...
        d3_selection_1.select('.size-small')
            .append('span')
        ...
        d3_selection_1.select('.size-default')
            .append('span')
            .style('position', 'absolute')
            .style('left', '10px')
            .style('top', '10px')
        ...
        d3_selection_1.select('.size-large')
            .append('span')
            .style('position', 'absolute')
            .style('left', '10px')
            .style('top', '10px')
        ...
        var log = d3_selection_1.select('.size-wrap>div:first-child');
        var smallContextmenu = new ContextMenu_1.ContextMenu({
            selector: '.size-small',
            mode: 'fixed',
            size: 'small',
            menus: getMenus(log)
        });
        var defaultContextmenu = new ContextMenu_1.ContextMenu({
            selector: '.size-default',
            mode: 'fixed',
            size: 'default',
            menus: getMenus(log)
        });
        var largeContextmenu = new ContextMenu_1.ContextMenu({
            selector: '.size-large',
            mode: 'fixed',
            size: 'large',
            menus: getMenus(log)
...
exports.Main = Main;
new Main();
function getMenus(log) {
    var menus = [
        { name: '新增', handler: function () { log.append('p').html('你点击了新增按钮。'); } },
        { name: '修改', handler: function () { log.append('p').html('你点击了修改按钮。'); } },
        { name: '删除', handler: function () { log.append('p').html('你点击了删除按钮。'); } },
        {
            name: '更多1',
            children: [
                {
                    name: '更多1-1',
                    children: [
                        { name: '更多1-1-1', handler: function () { log.append('p').html('你点击了更多1-1-1按钮。'); } },
                        { name: '更多1-1-2', handler: function () { log.append('p').html('你点击了更多1-1-2按钮。'); } },
                    ]
                },
        ...
        { name: '这是一段很长的自适应内容，你可以通过调整maxWidth改变最长宽度限制，默认值160', handler: function () { log.append('p').html('你点击了这是一段很长的自适应内容按钮。'); } }
    ];
    return menus;
}
